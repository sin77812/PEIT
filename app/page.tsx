...
export default function Home() {
  return (
    <div className="relative h-screen -mt-16 overflow-hidden">
      ...
      {/* 중앙 콘텐츠 */}
      <div className="relative z-10 flex flex-col items-center justify-center md:justify-start h-full px-8 sm:px-12 md:px-4 md:pt-[calc(25vh+4rem)] translate-y-[30vh] md:translate-y-0">
